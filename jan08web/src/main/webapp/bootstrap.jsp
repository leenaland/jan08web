...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm"
		...
		<div class="container px-5">
			<a class="navbar-brand fw-bold" href="#page-top">무니월드</a>
	...
	<section>
		...
		<button type="button" class="btn btn-warning">삐용삐용</button>
	...
	<footer class="bg-black text-center py-5">
		<div class="container px-5">
			<div class="text-white-50 small">
				<div class="mb-2">&copy; Your Website 2023. All Rights
					Reserved.</div>
